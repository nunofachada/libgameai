...
namespace Tests.PathFinding
{
    public class AStarPathFinderTests
    {
        ...
        public static IEnumerable<object[]> GetGraphsWithPath()
        {
            yield return new object[]
            {
                ...
                // Heuristics
                new float[] { 7.0f, 6.0f, 3.0f, 5.5f, 4.1f, 0.2f, 2.0f, 0.0f },
                0, // Start node
                7  // End node
            };
            yield return new object[]
        ...
        [Theory]
        [MemberData(nameof(GetGraphsWithPath))]
        public void TestFindPath_Find_Yes(
            IGraph graph, float[] heuristics, int from, int to)
        {
            // Instantiate an A* path finder
            IPathFinder pathFinder = new AStarPathFinder((i) => heuristics[i]);
